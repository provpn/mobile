...
import (
	...
	"github.com/provpn/mobile/internal/importers/java"
)
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/provpn/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/provpn/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
