...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/provpn/mobile/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/provpn/mobile/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/provpn/mobile/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		if out, err := exec.Command("go", "build", "-o", bin.Name(), "github.com/provpn/mobile/cmd/gobind").CombinedOutput(); err != nil {
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/provpn/mobile to generate code for reverse bindings.
			Name:  "github.com/provpn/mobile",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
