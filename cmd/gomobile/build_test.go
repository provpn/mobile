...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/provpn/mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/provpn/mobile", "github.com/provpn/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/provpn/mobile", "github.com/provpn/mobile", 2},
		{"ffffffff t github.com/example/github.com/provpn/mobile", "", 0},
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/provpn/mobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
